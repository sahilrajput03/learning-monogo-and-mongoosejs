...
const PERSON_COLLECTION_NAME = "persons"; //You should always use pluras names, otherwise mongodb will itself change the name to plurals. Yikes!
const GADGET_COLLECTION_NAME = "gadgets"; //You should always use pluras names, otherwise mongodb will itself change the name to plurals. Yikes!
...
module.exports = {connection, personModel, gadgetModel, GADGET_COLLECTION_NAME};
